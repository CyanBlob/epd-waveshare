...
/// - Rotations
/// - Clearing
pub trait TriDisplayCompact: DrawTarget<Color = TriColor> {
    /// Clears the black/white buffer of the display with the chosen background color
    ...
    /// Clears the chromatic buffer of the display with the chosen background color
